...
import {Chat, Message, Publication, User, UserRelations, Owner, Ownerhasfollowers} from '../models';
...
> {
  ...
  public readonly owners: HasManyRepositoryFactory<Owner, typeof User.prototype.id>;

  public readonly ownerhasfollowers: HasManyRepositoryFactory<Ownerhasfollowers, typeof User.prototype.id>;
  ...
  constructor(
    ...
    protected messageRepositoryGetter: Getter<MessageRepository>, @repository.getter('OwnerRepository') protected ownerRepositoryGetter: Getter<OwnerRepository>, @repository.getter('OwnerhasfollowersRepository') protected ownerhasfollowersRepositoryGetter: Getter<OwnerhasfollowersRepository>,
  ) {
